...
You did not implement this change. Review only; do not modify files unless explicitly instructed.

Read `AGENTS.md`, the issue, active plan, relevant architecture/ADRs, and `docs/evaluation.md`. Review the complete feature-branch diff against its base, including uncommitted working-tree changes.
